...
public class FrmItemCompra extends javax.swing.JDialog {
    ...
    private static DaoItemCompra itemRetorno;

    private FrmItemCompra(DaoItemCompra item) throws SQLException, ClassNotFoundException {
        ...
        System.out.println(item.getNumCompra());
        txtNumCompra.setText(String.valueOf(item.getNumCompra()));
        ...
        try {
            ...
            throw new SQLException("Ocorreu um erro no Formulário de compras: \n" + e.getMessage(), "Erro");
        } catch (ClassNotFoundException e) {
            throw new ClassNotFoundException("Ocorreu um erro no Formulário de compras: \n" + e.getMessage());
        }
    }
    
    public static DaoItemCompra showItemCompra(DaoItemCompra item) throws SQLException, ClassNotFoundException {
        FrmItemCompra frmItemCompra = new FrmItemCompra(item);
        return itemRetorno;
    ...
    private void btnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOkActionPerformed
        ...
        try {
            itemRetorno.setNumCompra(Integer.valueOf(txtNumCompra.getText()));
            ...
            JOptionPane.showMessageDialog(null, "Ocorreu um erro ao retornar o NOVO Item para essa compra:\n" + e.getMessage(), "Erro:", JOptionPane.ERROR_MESSAGE);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmItemCompra.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
