...
public class FrmAbout extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/esqueleto.gif"))); // NOI18N

        jLabel4.setText("Versão alpha 1.1.4");

        jLabel3.setText("Todos direitos reservados");

        jLabel6.setText("Guilherme & Mayara");

        jTextArea1.setEditable(false);
        jTextArea1.setColumns(20);
        jTextArea1.setRows(5);
        jTextArea1.setText("Programa dedicado à controlar vendas e compras,\nbuscando otimizar os atuais processos.\n");
